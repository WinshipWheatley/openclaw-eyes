...
def _text_response_ready_fast_path_status_payload(
    ...
    *,
    ...
    spoken_packet_present = isinstance(spoken_packet, Mapping) and bool(spoken_packet)
    guardian_output_gate_present = isinstance(guardian_gate_payload, Mapping) and bool(guardian_gate_payload)
    local_surface_request_present = isinstance(local_surface_request, Mapping) and bool(local_surface_request)
    response_taste_guardrails_present = isinstance(taste_guardrails, Mapping) and bool(taste_guardrails)
    machine_proof: dict[str, Any] = {
        ...
        "network_used": False,
        "send_submit_performed": False,
        "spoken_response_packet_present": spoken_packet_present,
        "spoken_script_truth_bound": spoken_packet_present,
        "role_output_blocked": not bool(guardian_gate_result.get("output_publish_allowed")),
        "guardian_output_gate_present": guardian_output_gate_present,
        ...
        "local_surface_request_present": local_surface_request_present,
        "local_surface_request_local_only": local_surface_request.get("local_only"),
        "response_taste_guardrails_present": response_taste_guardrails_present,
        ...
        status_payload["machine_proof"].update(
            {
                ...
                "spoken_response_packet_present": isinstance(spoken_packet, Mapping) and bool(spoken_packet),
                "spoken_script_truth_bound": isinstance(spoken_packet, Mapping) and bool(spoken_packet),
