...
from launch_ladder_contract_check import (
    ...
    backend_data_contract_first_sqlite_implementation_plan_failures,
...
def test_workspace_launch_profile_source_set_and_apple_platform_posture_are_documented():
    ...
    assert "active app-planning posture is `03_MAC_APP_KNOWLEDGE_SUBSTRATE`" in launch_text
...
def test_backend_data_contract_static_gate_artifacts_are_documented():
    ...
    assert backend_data_contract_first_sqlite_implementation_plan_failures() == ()
...
def test_backend_storage_schema_plan_check_is_part_of_main_contract(monkeypatch):
    sentinel = "backend storage/schema plan sentinel failure"
...
def test_backend_sqlite_plan_check_is_part_of_main_contract(monkeypatch):
    sentinel = "backend SQLite plan sentinel failure"
...
def test_backend_first_sqlite_implementation_plan_check_is_part_of_main_contract(
    monkeypatch,
):
    sentinel = "backend first SQLite implementation plan sentinel failure"
