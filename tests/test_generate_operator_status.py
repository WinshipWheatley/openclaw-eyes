...
def test_generate_current_state(mock_snapshot):
    ...
    gate_line = gate_lines[0].lower()
    for word in ["executed", "completed", "approved", "success", "done"]:
        assert word not in gate_line, f"Misleading word '{word}' found in gate receipt line: {gate_line}"
