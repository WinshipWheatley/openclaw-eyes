...
Status: `LM2_ROOM_BACKED_WORKER_STRUCTURED_OUTPUT_RETRY_READY`
...
- Method: `ollama_api_generate_format_json_schema`
- Format schema sent: `true`
- Enforced: `true`
- Unavailable reason: ``
...
- HTTP status: `200`
- Timed out: `false`
- Publication: `verified_text_published`
...
- `structured_output_boundary_receipt`: present
...
- `schema_adapter_pass_fail_receipt`: present
- `worker_stopped_receipt`: present
- `verifier_pass_fail_receipt`: present
- `published_response_hash_receipt`: present
