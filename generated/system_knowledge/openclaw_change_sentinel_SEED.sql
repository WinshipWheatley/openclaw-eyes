INSERT INTO sentinel_run (run_ref, generated_at, run_status, baseline_available, observed_target_count, observed_change_count, material_change_count, lm_called, timer_installed, chief_launched) VALUES ('openclaw_change_sentinel_run', '2026-05-31T03:27:15+00:00', 'NO_MATERIAL_CHANGE', 1, 20, 0, 0, 0, 0, 0);
...
INSERT INTO observed_target (target_ref, target_type, source_path, observation_status, observed_value, fingerprint, observed_json, unreachable_reason, observed_at) VALUES ('mac_mirror:openclaw_eyes_registry_review_branch', 'MAC_HEARTBEAT', 'generated/read_models/openclaw_reference_resolver.json', 'UNKNOWN', 'LOCAL_PATH_UNREACHABLE', 'sha256:c705c7196044eb308cf73a993c13fb0af215f0ae4aa4873afd1beaf90d0ea160', '{
  ...
  "target_ref": "openclaw_eyes_registry_review_branch"
}', 'LOCAL_PATH_UNREACHABLE', '2026-05-31T03:27:15+00:00');
...
}', 'source or bridge counterpart missing', '2026-05-31T03:27:15+00:00');
...
INSERT INTO observed_target (target_ref, target_type, source_path, observation_status, observed_value, fingerprint, observed_json, unreachable_reason, observed_at) VALUES ('service_restart_count:openclaw-request-response.service', 'SERVICE', 'systemd:user:show', 'NO_MATERIAL_CHANGE', '39', 'sha256:3faaca7fe23d9f9931a196e4b92d8d735b27ba6c7ef1c3d9b05b2fd23b3a79d3', '{
  "active_state": "active",
  "available": true,
  "error": "",
  "exec_main_status": "0",
