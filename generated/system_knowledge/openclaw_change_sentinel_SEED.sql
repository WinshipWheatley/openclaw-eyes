INSERT INTO sentinel_run (run_ref, generated_at, run_status, baseline_available, observed_target_count, observed_change_count, material_change_count, lm_called, timer_installed, chief_launched) VALUES ('openclaw_change_sentinel_run', '2026-06-08T14:14:23+00:00', 'MATERIAL_CHANGE_DETECTED', 1, 30, 2, 2, 0, 0, 0);
...
INSERT INTO observed_target (target_ref, target_type, source_path, observation_status, observed_value, fingerprint, observed_json, unreachable_reason, observed_at) VALUES ('mac_mirror:openclaw_eyes_registry_review_branch', 'MAC_HEARTBEAT', 'generated/read_models/openclaw_reference_resolver.json', 'UNKNOWN', 'LOCAL_PATH_UNREACHABLE', 'sha256:c705c7196044eb308cf73a993c13fb0af215f0ae4aa4873afd1beaf90d0ea160', '{
  ...
  "target_ref": "openclaw_eyes_registry_review_branch"
}', 'LOCAL_PATH_UNREACHABLE', '2026-06-08T14:14:23+00:00');
...
INSERT INTO observed_target (target_ref, target_type, source_path, observation_status, observed_value, fingerprint, observed_json, unreachable_reason, observed_at) VALUES ('mac_mirror:openclaw_eyes_main_branch', 'MAC_HEARTBEAT', 'generated/read_models/openclaw_reference_resolver.json', 'UNKNOWN', 'UNKNOWN', 'sha256:162fb073f72649f1dba8febcb1e40f3d5dbc74be46eadf86d52e3e48e36442a6', '{
  ...
  "target_ref": "openclaw_eyes_main_branch"
}', 'UNKNOWN', '2026-06-08T14:14:23+00:00');
...
}', 'source or bridge counterpart missing', '2026-06-08T14:14:23+00:00');
...
INSERT INTO observed_target (target_ref, target_type, source_path, observation_status, observed_value, fingerprint, observed_json, unreachable_reason, observed_at) VALUES ('mac_heartbeat:sync_health', 'MAC_HEARTBEAT', 'generated/read_models/sync_health.json', 'BRIDGE_STALE', 'stale_needs_mac_sync', 'sha256:9078664d318a62f1d0450224c86f90337c6c873198cda52596c9b83acb68175e', '{
  ...
  "last_mac_heartbeat": {
    ...
    "marker_seen": true,
    "status": "idle",
    "time": "2026-06-08T14:05:16+00:00"
  },
  "mirror_status": "needs_mac_sync",
  "missing_expected": 437,
...
}', 'input hash mismatch: live_arts_bundle, capital_hilton_bundle', '2026-06-08T14:14:23+00:00');
...
INSERT INTO observed_change (change_ref, target_ref, change_status, before_value, after_value, before_fingerprint, after_fingerprint, reason, detected_at) VALUES ('change:service_status:openclaw-request-response.service', 'service_status:openclaw-request-response.service', 'MATERIAL_CHANGE_DETECTED', 'active', 'active', 'sha256:dcc03fab43b1ee344c2fd174ad827111a8fbb7b904f86bf054975154f1397d6b', 'sha256:bff64a3058add84ef895dfd067db69258c3b4766367b9d996795b18868d94f31', 'service_status:openclaw-request-response.service changed from ''active'' to ''active''.', '2026-06-08T14:14:23+00:00');
INSERT INTO observed_change (change_ref, target_ref, change_status, before_value, after_value, before_fingerprint, after_fingerprint, reason, detected_at) VALUES ('change:service_restart_count:openclaw-request-response.service', 'service_restart_count:openclaw-request-response.service', 'MATERIAL_CHANGE_DETECTED', '2', '0', 'sha256:dcc03fab43b1ee344c2fd174ad827111a8fbb7b904f86bf054975154f1397d6b', 'sha256:bff64a3058add84ef895dfd067db69258c3b4766367b9d996795b18868d94f31', 'service_restart_count:openclaw-request-response.service changed from ''2'' to ''0''.', '2026-06-08T14:14:23+00:00');
...
INSERT INTO material_change (material_ref, change_ref, material_status, severity, operator_summary, action_required, can_wait) VALUES ('material:service_restart_count:openclaw-request-response.service', 'change:service_restart_count:openclaw-request-response.service', 'MATERIAL_CHANGE_DETECTED', 'MEDIUM', 'service_restart_count:openclaw-request-response.service changed from ''2'' to ''0''.', 0, 1);
