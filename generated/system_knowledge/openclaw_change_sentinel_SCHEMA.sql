CREATE TABLE sentinel_run (
    ...
    run_status TEXT NOT NULL CHECK(run_status IN ('NO_MATERIAL_CHANGE', 'MATERIAL_CHANGE_DETECTED', 'DRIFT_DETECTED', 'BRIDGE_STALE', 'SERVICE_UNSTABLE', 'REPO_DIRTY', 'REMOTE_REF_MOVED', 'WORKFLOW_STATE_CHANGED', 'ACTION_REQUIRED', 'UNKNOWN')),
...
CREATE TABLE observed_target (
    ...
    observation_status TEXT NOT NULL CHECK(observation_status IN ('NO_MATERIAL_CHANGE', 'MATERIAL_CHANGE_DETECTED', 'DRIFT_DETECTED', 'BRIDGE_STALE', 'SERVICE_UNSTABLE', 'REPO_DIRTY', 'REMOTE_REF_MOVED', 'WORKFLOW_STATE_CHANGED', 'ACTION_REQUIRED', 'UNKNOWN')),
...
CREATE TABLE observed_change (
    ...
    change_status TEXT NOT NULL CHECK(change_status IN ('NO_MATERIAL_CHANGE', 'MATERIAL_CHANGE_DETECTED', 'DRIFT_DETECTED', 'BRIDGE_STALE', 'SERVICE_UNSTABLE', 'REPO_DIRTY', 'REMOTE_REF_MOVED', 'WORKFLOW_STATE_CHANGED', 'ACTION_REQUIRED', 'UNKNOWN')),
...
CREATE TABLE material_change (
    ...
    material_status TEXT NOT NULL CHECK(material_status IN ('NO_MATERIAL_CHANGE', 'MATERIAL_CHANGE_DETECTED', 'DRIFT_DETECTED', 'BRIDGE_STALE', 'SERVICE_UNSTABLE', 'REPO_DIRTY', 'REMOTE_REF_MOVED', 'WORKFLOW_STATE_CHANGED', 'ACTION_REQUIRED', 'UNKNOWN')),
...
CREATE TABLE recommended_action (
    ...
    status TEXT NOT NULL CHECK(status IN ('NO_MATERIAL_CHANGE', 'MATERIAL_CHANGE_DETECTED', 'DRIFT_DETECTED', 'BRIDGE_STALE', 'SERVICE_UNSTABLE', 'REPO_DIRTY', 'REMOTE_REF_MOVED', 'WORKFLOW_STATE_CHANGED', 'ACTION_REQUIRED', 'UNKNOWN')),
    reason TEXT NOT NULL,
    can_wait INTEGER NOT NULL CHECK(can_wait IN (0, 1)),
