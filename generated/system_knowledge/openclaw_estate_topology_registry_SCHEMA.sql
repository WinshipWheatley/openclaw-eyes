CREATE TABLE machine (
    ...
    evidence_status TEXT NOT NULL CHECK(evidence_status IN ('CONFIRMED', 'PARTIAL', 'UNKNOWN', 'MISSING', 'RESOLVED_LOCAL', 'RESOLVED_REMOTE', 'RESOLVED_MAC_BRIDGE', 'UNREACHABLE', 'LOCAL_PATH_UNREACHABLE', 'REMOTE_UNAVAILABLE', 'MAC_BRIDGE_UNAVAILABLE', 'PRESENT_ON_REVIEW_BRANCH', 'PENDING_REVIEW', 'CANONICAL_ON_MAIN', 'CANONICAL', 'EXTERNAL_REGISTRY_MATERIALIZED', 'PLANNED', 'STALE', 'DIRTY', 'CLEAN')),
    notes TEXT NOT NULL
);
