...
DEFAULT_AGENT_LANE_SEEDS: tuple[AgentLaneSeed, ...] = (
    ...
    AgentLaneSeed(
        ...
        lane_label="Operator Communications",
        status="active_registry",
        authority_level="advisory_only",
        role_summary="Frame operator-facing summaries, Telegram-ready responses, and status explanations.",
        allowed_worlds=("communications", "operations", "cross_world"),
        allowed_input_kinds=(
            "operator_intent",
            "generated_read_model",
            "context_packet",
        ...
        allowed_output_kinds=("summary", "draft_message", "operator_briefing", "telegram_ready_response"),
        blocked_output_kinds=("external_send", "approval_decision", "direct_execution", "truth_promotion"),
        approval_required_for=("sending_messages", "external_comms", "action_requests"),
        receipt_required_for=("draft_message", "operator_briefing"),
        source_kind_postures=_default_sources(primary_posture="metadata_only"),
        aliases=("operator_briefing", "comms_lane"),
        routing_hints=("operator summaries", "message drafting", "status explanation"),
        notes="Telegram-ready means metadata and wording shape only; no Telegram API is wired by this registry.",
    ),
    AgentLaneSeed(
        agent_id="guardian",
    ...
    AgentLaneSeed(
        ...
        notes="Hermes outputs are advisory surfaces only and cannot promote truth.",
    ),
    AgentLaneSeed(
