...
_RULES: tuple[_Rule, ...] = (
    ...
    _Rule(
        ...
        (
            ...
            "do the next thing",
            "next safe action",
            "next safe stabilization slice",
            "next smallest useful stabilization slice",
            "next smallest useful stabilization move",
            "stabilization slice",
            "review current state",
            "review the current operator harness state",
        ),
    ),
    _Rule(
        "status_brief",
...
def sample_phrase_matrix() -> tuple[tuple[str, str], ...]:
    ...
    return (
        ...
        ("Review the current Operator Harness state and recommend the next smallest useful stabilization slice", "next_safe_action"),
        ("Recommend the next safe stabilization slice", "next_safe_action"),
        ("What is the next smallest useful stabilization move?", "next_safe_action"),
        ("Review current state and tell me the next safe action", "next_safe_action"),
