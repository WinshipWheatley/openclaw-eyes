...
- **Current Docs Slice:** this repo-truth refresh, the active handoff refresh, the runtime in-memory readiness bridge, and two index discoverability updates are pending review/commit until committed.
...
- The `24_files/` stable packet contents were not changed by this repo-truth refresh.
