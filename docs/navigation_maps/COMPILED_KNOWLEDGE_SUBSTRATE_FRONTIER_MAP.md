...
- **Receipt Command:** `./scripts/openclaw_receipts.py operator-frontier-map-status`

## Built Territory
*These items are completed and must cite proof.*
...
- **Operator-frontier-map-status receipt command:** `./scripts/openclaw_receipts.py operator-frontier-map-status`
