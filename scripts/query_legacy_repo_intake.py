#!/usr/bin/env python3
"""Query Legacy GitHub Repo Intake v0 placeholder roots."""
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Query legacy repo intake placeholders.")
    parser.add_argument("--db", default=DEFAULT_DB_PATH, help="SQLite ledger path.")
    parser.add_argument("--run-id", help="Run id. Defaults to latest.")
    parser.add_argument(
        "--report",
        choices=("summary", "roots", "promotion-candidates", "risks"),
        default="summary",
        help="Report section.",
    )
    parser.add_argument(
