...
EXPECTED_CORE_ARTIFACT_IDS = {
    ...
    "world_status_output_contract",
    "artifact_registry_output_contract",
    "evidence_freshness_output_contract",
...
EXPECTED_STANDARDIZED_EXPORT_IDS = {
    ...
    "world_status_json_export",
    "world_status_operator_export",
    ...
    "evidence_freshness_json_export",
    "evidence_freshness_operator_export",
...
STANDARDIZED_EXPORT_DEFINITIONS: tuple[dict[str, Any], ...] = (
    ...
    _standardized_export_definition(
        artifact_id="world_status_json_export",
        label="World Status JSON Export",
        relative_path="world_status.json",
        expected_format="json",
        source_artifact_id="world_status_output_contract",
        source_producer_script="scripts/build_world_status.py",
        source_producer_command="python3 scripts/build_world_status.py --format json",
        tags=_tags("world_status", "standardized_export", "app_fixture_safe", "codex_context_safe"),
        authority_label="standardized_registry_status_export",
    ),
    _standardized_export_definition(
        artifact_id="world_status_operator_export",
        label="World Status Operator Export",
        relative_path="world_status.operator.txt",
        expected_format="operator_text",
        source_artifact_id="world_status_output_contract",
        source_producer_script="scripts/build_world_status.py",
        source_producer_command="python3 scripts/build_world_status.py --format operator",
        tags=_tags("world_status", "standardized_export", "app_fixture_safe", "codex_context_safe"),
        authority_label="standardized_registry_status_export",
    ),
    _standardized_export_definition(
    ...
    _standardized_export_definition(
        artifact_id="evidence_freshness_json_export",
        label="Evidence Freshness JSON Export",
        relative_path="evidence_freshness.json",
        expected_format="json",
        source_artifact_id="evidence_freshness_output_contract",
        source_producer_script="scripts/build_evidence_freshness.py",
        source_producer_command="python3 scripts/build_evidence_freshness.py --format json",
        tags=_tags("evidence_freshness", "standardized_export", "app_fixture_safe", "codex_context_safe"),
        authority_label="standardized_freshness_export",
    ),
    _standardized_export_definition(
        artifact_id="evidence_freshness_operator_export",
        label="Evidence Freshness Operator Export",
        relative_path="evidence_freshness.operator.txt",
        expected_format="operator_text",
        source_artifact_id="evidence_freshness_output_contract",
        source_producer_script="scripts/build_evidence_freshness.py",
        source_producer_command="python3 scripts/build_evidence_freshness.py --format operator",
        tags=_tags("evidence_freshness", "standardized_export", "app_fixture_safe", "codex_context_safe"),
        authority_label="standardized_freshness_export",
    ),
    _standardized_export_definition(
...
ARTIFACT_DEFINITIONS: tuple[dict[str, Any], ...] = (
    ...
    {
        "artifact_id": "world_status_output_contract",
        "label": "World Status Output Contract",
        "artifact_type": "producer_output_contract",
        "path_or_command": "python3 scripts/build_world_status.py --format json",
        "producer_script": "scripts/build_world_status.py",
        "producer_command": "python3 scripts/build_world_status.py --format json",
        "expected_format": "json",
        "tags": _tags("world_status", "app_fixture_safe", "codex_context_safe"),
        "authority_label": "inspect_only_registry_status_read_model",
        "generated_on_demand": True,
        "current_status_source": "world_domain_registry_v0",
        "safe_for_mac_app": True,
        "safe_for_codex_context": True,
        "safe_for_nohup_workers": True,
        "safe_for_agent_context": True,
        "freshness_basis": "generated on demand from deterministic world/domain registry status",
        "verification_command": "python3 scripts/build_world_status.py --format json | python3 -m json.tool",
    },
    {
        "artifact_id": "artifact_registry_output_contract",
        "label": "Read-Model Artifact Registry Output Contract",
        "artifact_type": "producer_output_contract",
        "path_or_command": "python3 scripts/build_artifact_registry.py --format json",
        "producer_script": "scripts/build_artifact_registry.py",
        "producer_command": "python3 scripts/build_artifact_registry.py --format json",
        "expected_format": "json",
        "tags": _tags("artifact_registry", "app_fixture_safe", "codex_context_safe"),
        "authority_label": "metadata_only_artifact_registry",
        "generated_on_demand": True,
        "current_status_source": "registered_metadata_definitions",
        "safe_for_mac_app": True,
        "safe_for_codex_context": True,
        "safe_for_nohup_workers": True,
        "safe_for_agent_context": True,
        "freshness_basis": "generated on demand from explicit artifact registry definitions",
        "verification_command": "python3 scripts/build_artifact_registry.py --format json | python3 -m json.tool",
    },
    {
        "artifact_id": "evidence_freshness_output_contract",
        "label": "Evidence Freshness Output Contract",
        "artifact_type": "producer_output_contract",
        "path_or_command": "python3 scripts/build_evidence_freshness.py --format json",
        "producer_script": "scripts/build_evidence_freshness.py",
        "producer_command": "python3 scripts/build_evidence_freshness.py --format json",
        "expected_format": "json",
        "tags": _tags("evidence_freshness", "app_fixture_safe", "codex_context_safe"),
        "authority_label": "deterministic_freshness_read_model",
        "generated_on_demand": True,
        "current_status_source": "generated_status_check_and_export_check",
        "safe_for_mac_app": True,
        "safe_for_codex_context": True,
        "safe_for_nohup_workers": True,
        "safe_for_agent_context": True,
        "freshness_basis": "generated on demand from safe repo-local generated status and export checks",
        "verification_command": "python3 scripts/build_evidence_freshness.py --format json | python3 -m json.tool",
    },
    {
