#!/usr/bin/env python3
"""Export Governed Intake Spine read-model."""
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export Governed Intake Spine read-model.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    summary = export_governed_intake_spine_read_model(db_path=args.db, export_root=args.export_root)
    if args.format == "json":
