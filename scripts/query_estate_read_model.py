#!/usr/bin/env python3
"""Query Estate Topology read-model without exporting files."""
...
from estate_read_model import build_estate_read_model, format_estate_read_model, stable_json


def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Query Estate Topology read-model.")
