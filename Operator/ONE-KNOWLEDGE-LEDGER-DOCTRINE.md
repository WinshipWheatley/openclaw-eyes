...
2. **Runtime self-heal guard (LIVE).** At the packet-build chokepoint, if a registered
   ...
   The live guard receipt path is in `protected_generate.py:1152-1162`.
3. **Self-repair loop (LIVE — reuses the existing self-improvement loop + Guardian-gated factory).**
