...
FOLDER_2_FILES=(
  ...
  '08_expert_lane_contracts/expert_approval_packet.py|expert_approval_packet.py'
  '08_expert_lane_contracts/test_expert_approval_packet.py|test_expert_approval_packet.py'
