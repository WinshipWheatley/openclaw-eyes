    ...
    if action_kind == "regenerate_or_link_invoice_artifact":
        ...
        if not readiness.safe_to_generate and generator_readiness.GENERATION_AUTHORITY_RECEIPT in readiness.missing_inputs:
            ...
            return (
                ...
                "Next: request generation/export authority. If the artifact already exists, attach it via the governed external-artifact path.",
            ...
            capital["excel_invoice_artifact"]["manual_operator_actions"] = (
                {
                    ...
                    "enabled": False,
                    "disabled_reason": "Manual artifact export is not wired yet. Attach an external artifact if already prepared.",
